...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/Som795_V2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1360937237/adquisicion.o ${OBJECTDIR}/_ext/1360937237/comunicacion.o ${OBJECTDIR}/_ext/1360937237/generacion.o ${OBJECTDIR}/_ext/1360937237/app.o ${OBJECTDIR}/_ext/1360937237/mapas.o ${OBJECTDIR}/_ext/1360937237/temporalidades.o ${OBJECTDIR}/_ext/1360937237/globales.o ${OBJECTDIR}/_ext/1021348264/plib_adc.o ${OBJECTDIR}/_ext/1021350442/plib_clk.o ${OBJECTDIR}/_ext/1597161859/plib_evic.o ${OBJECTDIR}/_ext/1597215687/plib_gpio.o ${OBJECTDIR}/_ext/1453895535/plib_i2c2_master.o ${OBJECTDIR}/_ext/1079933584/plib_spi3_master.o ${OBJECTDIR}/_ext/1021366817/plib_tmr2.o ${OBJECTDIR}/_ext/1021366817/plib_tmr4.o ${OBJECTDIR}/_ext/1021366817/plib_tmr5.o ${OBJECTDIR}/_ext/1021366817/plib_tmr3.o ${OBJECTDIR}/_ext/1597618630/plib_uart2.o ${OBJECTDIR}/_ext/1597618630/plib_uart5.o ${OBJECTDIR}/_ext/538220530/xc32_monitor.o ${OBJECTDIR}/_ext/819485868/initialization.o ${OBJECTDIR}/_ext/819485868/interrupts.o ${OBJECTDIR}/_ext/819485868/exceptions.o ${OBJECTDIR}/_ext/1360937237/main.o
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-32mxSom.mk dist/${CND_CONF}/${IMAGE_TYPE}/Som795_V2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/Som795_V2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    ../src/config/32mxSom/p32MX795F512L.ld
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -g -mdebugger -D__MPLAB_DEBUGGER_ICD3=1 -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/Som795_V2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -DXPRJ_32mxSom=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)   -mreserve=data@0x0:0x1FC -mreserve=boot@0x1FC02000:0x1FC02FEF -mreserve=boot@0x1FC02000:0x1FC024FF  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,-D=__DEBUG_D,--defsym=__MPLAB_DEBUGGER_ICD3=1,--defsym=_min_heap_size=1024,--gc-sections,--no-code-in-dinit,--no-dinit-in-serial-mem,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -mdfp="${DFP_DIR}"
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/Som795_V2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   ../src/config/32mxSom/p32MX795F512L.ld
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/Som795_V2.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -DXPRJ_32mxSom=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=_min_heap_size=1024,--gc-sections,--no-code-in-dinit,--no-dinit-in-serial-mem,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -mdfp="${DFP_DIR}"
	${MP_CC_DIR}/xc32-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/Som795_V2.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} 
endif
