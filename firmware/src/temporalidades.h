...
//    int ExampleFunction(int param1, int param2);
        ...
        void ticks(void);
        void delayPulsoCkp(void);
        
        unsigned int ticksCkpCounter(void);
        unsigned int ticksCkpAjuste(void);
        void ticksCkpAjusteReset(void);
        
        unsigned int ticksCkpActual(void);
        void CkpCounterReset(void);
        
        
        unsigned int ckpActual_us(void);
        
        unsigned int ticksCmpCounter(void);
        unsigned int tickCmpActual(void);
        void CmpCounterReset(void);
        
        unsigned int cmpActual_us(void);
